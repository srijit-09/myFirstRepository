...
public class NewTest {
	...
	public void getAddress(String Adressline1, String city, String State, String zipcode) {
		...
		String address = "{\"addressLine1\":\" " + Adressline1 + "\"," + "\"addressLine2\":null,"
				+ "\"addressLine3\":null," + "\"addressLine4\":null," + "\"building\":\"RSA Union Bldg\","
				+ "\"city\":\"" + city + "\"," + "\"state\":\"" + State + "\"," + "\"zipCode\":\"" + zipcode + "\","
				+ "\"zip4\":null, " + "\"isocountryCode\":\"US\"}";
		/*
		 * String response = given().header("Authorization",
		 ...
		 * "application/json") .header("intuit_originatingip",
		 * "123.45.67.89").header("intuit_tid", "12345-67890-12345-67890-123451")
		 * .header("intuit_locale", "en_US").body(address) .post(
		 * "https://standardaddress-prf.platform.intuit.net/v1/StandardizedAddress").
		 * body().asString();
		 */
		...
		System.out.println("the zip4 is :" + zip4 + "the county Code is" + countyCode + "for state " + state
				+ "citycodeis" + cityCode);
